        ...
        <>
            <div className="">
                <div className="flex flex-col items-center md:mt-20 mt-10 mb-10 text-black">
                    ...
                    <p className="xl:max-w-2xl m-auto p-2 text-balance md:text-base text-sm text-center">SWARA ACADEMY OF PSYCHOLOGY (SAP) has been established to cater to the growing needs of the parents, educationists,
                    ...
                    <p className="xl:max-w-2xl m-auto md:text-base text-balance text-sm p-2 text-center mt-2">SWARA ACADEMY OF PSYCHOLOGY- A unique institute providing complete psycho-solution in India under one roof.
                    ...
                    <div className="mt-2 flex items-center gap-x-2 sm:text-sm text-xs">
                        <Link href="/services"><Button>Design Your Life</Button></Link>
