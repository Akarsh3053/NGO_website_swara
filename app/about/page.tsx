        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between items-center">
            ...
            <div className="md:w-2/3 mb-4 md:mb-0">
              <p className="text-lg font-medium text-gray-800 text-balance leading-relaxed pr-8 text-center md:text-left">
              ...
              <p className="text-lg font-medium text-balance text-gray-800 leading-relaxed mt-4 pr-8 text-center md:text-left">
