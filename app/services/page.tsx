            ...
            <div className='max-w-[1300px] m-auto p-2'>
                <div className='flex items-center flex-wrap-reverse gap-x-10  '>
                    <div className=' max-w-3xl '>
                        ...
                        <div className='font-normal text-base text-balance'>
                ...
                <div>
                    ...
                    <p className='text-main mt-2 max-w-5xl text-xl font-semibold text-balance'>We provide several services for families facing problems such as lack of coordination, lack of bonding among members etc. We at Swara Foundation believe that one can only be mentally fit if there is a healthy family environment. We offer following services -</p>
                    ...
                    <p className='text-main mt-2 max-w-5xl text-xl font-semibold text-balance'>We also deal with some special behavioral problems of children and adolescents in their growing age they go through several changes mentally and physically hence its very common. So we designed our session considering these things so that we can help both parents and children to overcome such problems.</p>
                </div>
            </div>
        </div>
    )
